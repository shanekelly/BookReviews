...
public class Review { // Class representing a Review entity.
    ...
    private int id; // Field representing the ID of the review.

    private int bookId; // Field representing the ID of the book associated with the review.
    private String review; // Field representing the review text.
}
